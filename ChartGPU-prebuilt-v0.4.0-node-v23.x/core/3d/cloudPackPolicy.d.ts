 ...
 */
export declare function resolveCloudValueChannelIdentity(data: PointCloud3DData | unknown, colorByValues?: ArrayLike<number> | null): unknown;
/**
 * True when an existing packed buffer (keyed by previous seed) must be discarded
 * and rebuilt from the next series config.
 */
export declare function shouldInvalidateCloudPack(previous: CloudPackSeed | null | undefined, next: CloudPackSeed): boolean;
/** Inverse of shouldInvalidateCloudPack for readable tests. */
export declare function shouldKeepCloudPack(previous: CloudPackSeed | null | undefined, next: CloudPackSeed): boolean;
//# sourceMappingURL=cloudPackPolicy.d.ts.map