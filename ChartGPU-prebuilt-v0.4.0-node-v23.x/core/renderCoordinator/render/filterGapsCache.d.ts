...
export type FilterGapsCache = Map<number, Readonly<{
    data: unknown;
    /** Point count at the time of filtering (guards same-ref append growth). */
    pointCount: number;
    filtered: ReadonlyArray<DataPoint>;
}>>;
export declare function createFilterGapsCache(): FilterGapsCache;
/**
 ...
 * series index.
 */
export declare function getFilteredGapsCached(cache: FilterGapsCache, seriesIndex: number, data: CartesianSeriesData): ReadonlyArray<DataPoint>;
//# sourceMappingURL=filterGapsCache.d.ts.map