 ...
 */
export declare const DENSE_SCATTER_DENSITY_LO = 0.08;
/**
 ...
 */
export declare const DENSE_SCATTER_DENSITY_HI = 0.3;
/**
 ...
 */
export declare const DENSE_SCATTER_POINT_COUNT_FULL_COMPACT = 250000;
/** Minimum drawn radius in device pixels under denseCompact. */
export declare const DENSE_SCATTER_MIN_RADIUS_DEVICE_PX = 1;
/**
 ...
 */
export declare function resolveScatterDrawPolicy(input: ScatterDrawPolicyInput): ScatterDrawPolicyResult;
//# sourceMappingURL=scatterDrawPolicy.d.ts.map