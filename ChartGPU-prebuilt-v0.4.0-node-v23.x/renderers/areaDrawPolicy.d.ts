 ...
 * @internal
 */
import { DENSE_DRAW_POINT_THRESHOLD, DENSE_DRAW_MIN_TARGET_SEGMENTS, DENSE_DRAW_WIDTH_OVERSAMPLE } from './denseDrawLod';
...
export { DENSE_DRAW_POINT_THRESHOLD as DENSE_AREA_POINT_THRESHOLD, DENSE_DRAW_MIN_TARGET_SEGMENTS as DENSE_AREA_MIN_TARGET_SEGMENTS, DENSE_DRAW_WIDTH_OVERSAMPLE as DENSE_AREA_WIDTH_OVERSAMPLE, };
/**
 * Resolve mountain/area fill draw policy for the current prepare.
 */
export declare function resolveAreaDrawPolicy(input: AreaDrawPolicyInput): AreaDrawPolicyResult;
//# sourceMappingURL=areaDrawPolicy.d.ts.map