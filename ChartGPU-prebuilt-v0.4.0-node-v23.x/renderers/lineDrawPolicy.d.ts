 ...
 */
export declare const DENSE_HAIRLINE_POINT_THRESHOLD = 25000;
/**
 ...
 */
export declare const MULTI_SERIES_HAIRLINE_SEGMENT_BUDGET = 500000;
/** Floor width reported for hairline bookkeeping (CSS px). Native stroke is 1 device px. */
export declare const DENSE_LINE_MIN_WIDTH_CSS = 1;
/**
 ...
 */
export declare function resolveLineDrawPolicy(input: LineDrawPolicyInput): LineDrawPolicyResult;
//# sourceMappingURL=lineDrawPolicy.d.ts.map