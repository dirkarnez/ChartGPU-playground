...
export type SeriesType = 'line' | 'area' | 'bar' | 'scatter' | 'pie' | 'candlestick' | 'ohlc' | 'heatmap' | 'band' | 'errorBar' | 'impulse' | 'pointCloud3d' | 'surface3d';
/**
 ...
 */
export type Surface3DUpdate = Readonly<{
    mode: 'replaceY';
    y: ArrayLike<number>;
    yMin?: number;
    yMax?: number;
 ...
 */
export type HeatmapUpdate = Readonly<{
    mode: 'replaceZ';
    z: ArrayLike<number>;
...
export type PointCloud3DData = ReadonlyArray<readonly [number, number, number] | {
    x: number;
    y: number;
    z: number;
} | null> | PointCloud3DArraysData | InterleavedXYZData;
 ...
 */
export type ErrorBarRelativeArraysData = Readonly<{
    readonly x: ArrayLike<number>;
    readonly y: ArrayLike<number>;
...
export type ErrorBarSeriesData = ReadonlyArray<ErrorBarPointTuple | ErrorBarPointObject | null> | ErrorBarHlcArraysData | ErrorBarRelativeArraysData;
...
export type SeriesConfig = LineSeriesConfig | AreaSeriesConfig | BarSeriesConfig | ScatterSeriesConfig | PieSeriesConfig | CandlestickSeriesConfig | OhlcSeriesConfig | HeatmapSeriesConfig | BandSeriesConfig | ErrorBarSeriesConfig | ImpulseSeriesConfig | PointCloud3DSeriesConfig | Surface3DSeriesConfig;
/**
...
export type AnnotationConfig = (AnnotationLineX | AnnotationLineY | AnnotationPoint | AnnotationText | AnnotationBandX) & AnnotationConfigBase;
/**
